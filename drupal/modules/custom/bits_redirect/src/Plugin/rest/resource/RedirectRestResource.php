...
namespace Drupal\bits_redirect\Plugin\rest\resource;
 ...
 *
 * @RestResource(
 *   id = "redirect_rest_resource",
 *   label = @Translation("Redirect rest resource"),
 *   uri_paths = {
 *     "canonical" = "/v1/redirect/export"
 *   }
 * )
 */
class RedirectRestResource extends ResourceBase {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $container->get('logger.factory')->get('bits_redirect'),
