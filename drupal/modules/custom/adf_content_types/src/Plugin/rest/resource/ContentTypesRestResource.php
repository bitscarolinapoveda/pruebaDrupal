 ...
 *
 * @RestResource(
 *   id = "content_types_rest_resource",
 *   label = @Translation("Content types rest resource"),
 *   uri_paths = {
 *     "canonical" = "/content-types-resources"
 *   }
 * )
 */
class ContentTypesRestResource extends ResourceBase {
  ...
  /**
   * Constructs a new ContentTypesRestResource object.
   *
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $container->get('logger.factory')->get('adf_content_types'),
