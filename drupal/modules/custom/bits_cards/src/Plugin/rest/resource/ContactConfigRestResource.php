 ...
 * )
 */
class ContactConfigRestResource extends ResourceBase {
  ...
  /**
   * Constructs a new ContactConfigRestResource object.
   *
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $container->get('logger.factory')->get('bits_cards'),
  ...
  public function get() {
    ...
    $service = \Drupal::service('bits_cards.get_contact');
