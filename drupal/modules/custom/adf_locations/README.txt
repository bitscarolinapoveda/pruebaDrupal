...
3. The module automatically create a content type called
"Locations", with three fields:
- title
- address
- locations
4. Create the respective nodes based on the content type
"Locations"
5. From the endpoint, consult the records according to the
two established parameters.
